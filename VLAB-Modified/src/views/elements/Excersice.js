...
class Exersice extends Component {
	state = {
		...
		contents: [
			{
				option1: ' To determine or develop a range of possible program alternatives',
				option2: ' To explore or expose underlying assumptions or information leading to different judgements',
				option3: ' To seek out information which may generate a consensus on the part of the respondent group',
				option4: ' To correlate informed judgments on a topic spanning a wide range of disciplines'
			},
			{
